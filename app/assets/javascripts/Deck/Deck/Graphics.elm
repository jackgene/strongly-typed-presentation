...
logosByLanguage =
  ...
  , ( "Go"
    , svg [ height "1.5vw", viewBox "0 0 205.4 76.7", attribute "style" "enable-background:new 0 0 205.4 76.7;" ]
  ...
  , ( "ML"
    , span []
      [ -- Elm
        svg [ height "2.5vw", viewBox "0 0 355 322.95" ]
        [ g []
      ...
      , -- Haskell
        svg [ height "2.5vw", viewBox "0 0 175 120" ]
      ...
      , -- Rust
        svg [ height "2.5vw", viewBox "19 19 106 106" ]
        [ path
